...
# or with yarn
yarn add @dplus/base @dplus/themed
```

You can also make `alias` for package to help you with migration.

```bash
yarn add react-native-elements@npm:@dplus/themed
```
...
+ import { lightColors, darkColors } from '@dplus/themed'
```
...
```jsx
import { createTheme } from '@dplus/themed';
