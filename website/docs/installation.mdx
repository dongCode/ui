...
```bash
npm install @dplus/base@edge @dplus/themed@edge
```
...
```bash
yarn add @dplus/base@edge @dplus/themed@edge
```
...
```bash
# @dplus/base
yarn add @dplus/base@github:react-native-elements/react-native-elements#base

# @dplus/themed
yarn add @dplus/themed@github:react-native-elements/react-native-elements#themed
```
...
```bash
npx create-expo-app --template @dplus/template
```
...
```bash
npx create-expo-app --template @dplus/template@edge
```
...
```bash
yarn add  @dplus/base @dplus/themed react-native-web react-native-vector-icons
```
...
module.exports = override(
  ...
  babelInclude([
    path.resolve(__dirname, 'node_modules/@dplus/base'),
    path.resolve(__dirname, 'node_modules/@dplus/themed'),
